...
export function EditEventForm({ event, onClose }: EditEventFormProps) {
    ...
    const [dates, setDates] = useState<{ date: string; time: string; location?: string; useCustomLocation?: boolean }[]>(
        (event.dates ?? []).map((d) => ({
    ...
    function addDate() { setDates((p) => [...p, { date: "", time: "09:00 – 13:00", location: "", useCustomLocation: false }]) }
